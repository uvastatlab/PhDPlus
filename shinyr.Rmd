...
- Unzip shinyR.zip. (*Mac*: Double click the zipped file. *Win*: Right-click on the zip file and select "Extract All...")
...
- for teaching statistical concepts: [Example](http://consultr.uvadcos.io/correlation/)
...
* TIP: use `Ctrl + P` to jump to beginning/end of matching parentheses
...
Go to <a href = "https://at.virginia.edu/2SS695y" target = "_blank">https://at.virginia.edu/2SS695y</a> to access the exercise.
