...
- Download [shinR.zip](https://github.com/uvastatlab/phdplus/raw/master/shinyR.zip) to your computer. It contains an R script and the content of this page as a slide deck. Save it somewhere easy to find. 
...
- We would like to _modularize_ the call to `rnorm` so it only runs when we change the sample size and not the bin width.
...
[Click here](https://at.virginia.edu/2SS695y) to access the exercise.
