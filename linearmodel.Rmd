...
* Download [linearmodel.zip](https://github.com/uvastatlab/phdplus/raw/master/linearmodel.zip). It contains the R script we'll use today (linearmodel.R), an R script to recreate the introductory example here (intro_model.R), and a project file. 
