...
- Download this zipped folder (CF: need to link). It contains an R script (ggplot-workshop-2019.R) and the content of this page as a slide deck (ggplot2-pres.pdf).
...
We'll demonstrate `ggplot2` using the Albemarle County real estate data, which was downloaded from Office of Geographic Data Services. See Michele Claibourn's workshop for how data were obtained and prepared: https://uvastatlab.github.io/phdplus/dataprep.html
...
In this workshop we'll focus on the six largest cities in Albemarle county.
...
Since we have so much data our plot suffers from an enormous amount of overplotting. Later in the workshop we'll review some strategies to address this.
