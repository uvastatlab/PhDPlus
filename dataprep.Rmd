...
* Download the data files and R scripts:  
    + [Go to GitHub](https://github.com/uvastatlab/phdplus/blob/master/dataprepR.zip), and click "Download". The folder contains  two data files (CAMA_CardLevelData.txt, CAMA_ParcelInfo.txt) and two R scripts (intro_dplyr.R and data_prep.R).
